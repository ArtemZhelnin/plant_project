      ...
      <div className="analysis-metrics">
        <div className="analysis-metrics__block">
          <div className="analysis-metrics__row">
            ...
            <span className="analysis-metrics__value"><span className="skeleton inline-block h-4 w-24 rounded" /></span>
          </div>
          <div className="analysis-metrics__row">
        ...
        <div className="analysis-metrics__confidence">
          <div className="analysis-metrics__confidence-main">
            ...
            <span className="analysis-metrics__confidence-value"><span className="skeleton inline-block h-4 w-14 rounded" /></span>
          </div>
